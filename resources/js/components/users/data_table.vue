    ...
    export default {
        ...
        data() {
            return {
                ...
                information_fields: [
                    '#',
                    // {key: 'user_id', sortable: true, label: 'user_id'},
                    {key: 'user_name', sortable: true, label: 'Full name'},
                    {key: 'venue_en_name', sortable: true, label: 'venue'},
                    {key: 'user_email', sortable: true, label: 'email'},
                    {key: 'group_members', sortable: true, label: 'group members'},
                    'Actions',
                ],
                selected_items: [],
            }
