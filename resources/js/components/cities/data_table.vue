        ...
        data() {
            return {
                ...
                information_fields: [
                    ...
                    {key: 'fa_name', sortable: true, label: 'fa_name'},
                    {key: 'en_name', sortable: true, label: 'en_name'},
                    {key: 'fa_address', sortable: true, label: 'fa_address'},
                    {key: 'en_address', sortable: true, label: 'en_address'},
